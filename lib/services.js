...
var getParameterInstantiation = function () {
    return ast_types_1.builders.tsTypeParameterInstantiation(//泛型
    [ast_types_1.builders.tsTypeReference(ast_types_1.builders.identifier('T'))]);
};
...
var getFunctionDeclaration = function (config) {
    ...
    declaration.returnType = ast_types_1.builders.tsTypeAnnotation(ast_types_1.builders.tsTypeReference(ast_types_1.builders.identifier('ResType'), getParameterInstantiation()));
    return declaration;
};
/**
 * service generator
